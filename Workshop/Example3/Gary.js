...
(lib.Gary = function() {
	...
	this.myButton.setTransform(681.1,357.4,1,1,0,0,0,82.2,17);
	new cjs.ButtonHelper(this.myButton, 0, 1, 2, false, new lib.MyButton(), 3);
3
	// Gary
	this.instance = new lib.Hero();
	this.instance.setTransform(164.3,204.3,1,1,0,0,0,26.3,-125.7);

	this.addChild(this.instance,this.myButton);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(469.3,268.3,684.1,306.2);
