...
(lib.Gary = function() {
	...
	// Control
	this.faceBtn = new lib.MyButton();
	this.faceBtn.setTransform(608.7,351);
	new cjs.ButtonHelper(this.faceBtn, 0, 1, 2, false, new lib.MyButton(), 3);

	this.hairBtn = new lib.MyButton();
	this.hairBtn.setTransform(608.7,308);
	new cjs.ButtonHelper(this.hairBtn, 0, 1, 2, false, new lib.MyButton(), 3);

	this.actionBtn = new lib.MyButton();
	this.actionBtn.setTransform(608.7,265);
	new cjs.ButtonHelper(this.actionBtn, 0, 1, 2, false, new lib.MyButton(), 3);

	this.addChild(this.actionBtn,this.hairBtn,this.faceBtn);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(998.7,465,164.5,120);
